    ...
    ">
      ...
      ">
                    ...
                    <tbody>
                        <tr style="height: 0;">
                            ...
                            <td style="text-align: right;">
                                <span
                                    style="font-size: 16px; line-height: 30px; color: #ffffff;">{{ $details['date'] }}</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
          ...
          ">
              ...
              ">
                            Thank you for choosing Frontice Company. Use the following OTP
          ...
          ">
                    ...
                    <a href="mailto:archisketch@gmail.com"
                        style="color: #499fb6; text-decoration: none;">helps@frontice.com</a>
                    or visit our
